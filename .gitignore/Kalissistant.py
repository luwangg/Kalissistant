...
# Fix Configs
assistant += os.system("wget https://github.com/a9v8i/Kalissistant/raw/master/vlc -o /usr/bin/vlc && chmod +x /usr/bin/vlc && cp /root/vlc /usr/bin/vlc && chmod +x /usr/bin/vlc && rm /root/vlc && cd ~/Kalissistant && rm v* && wget https://github.com/a9v8i/Kalissistant/raw/master/vlc && chmod +x *")
